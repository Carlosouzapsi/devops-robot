...
User Session
    ...
    ${payload}   Factory User Session  login
      ...
      ### MODELAGEM PARA FAZER O LOGIN NA API
...
#### MANTIVE OS CENÁRIOS, APESAR DO PAPITO TER SUGERIDO APAGAR
# Incorrect pass

#     ${payload}  Create Dictionary    email=kate@email.com  password=abc123
...
#     ${payload}  Create Dictionary    email=kate@email.com         password=${EMPTY}
...
#     ${payload}  Create Dictionary    email=kate@email.com
